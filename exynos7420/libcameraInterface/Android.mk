...
LOCAL_C_INCLUDES += \
	...
	$(TOP)/hardware/samsung_slsi-linaro/$(TARGET_SOC)/libcameraSec \
	$(TOP)/hardware/samsung_slsi-linaro/$(TARGET_SOC)/libcameraSec/Vendor \
	$(TOP)/hardware/samsung_slsi-linaro/$(TARGET_SOC)/libcamera3Sec \
	$(TOP)/system/media/camera/include \
	$(TOP)/system/core/libion/include \
